...
public class MaquinariaController {
	...
	public @ResponseBody List<maquinas> maquinasListApi(){
	...
	public @ResponseBody List<maquinas> maquinaById(@RequestParam(value = "id", required = true, defaultValue = "1") Long identificador){
		
		System.out.println("Este es en /listAPIid  "+identificador);
		List<maquinas> maquinas=  maquinariaService.getMaquinasId(identificador);
		return maquinas;
	}
	...
	public @ResponseBody List<maquinas> maquinaUpdate(
		...
		List<maquinas> maquinas=  maquinariaService.updateMaquina(idmaquina, imagen, nombre, precio, descuento, descripcion, disponibilidad);
		return maquinas;
	}
